...
class NavbarAdmin extends Component {
  ...
  <a className="navbar-brand titre_logo" href="/" title="bouton_home">Suivi de potager</a>
    ...
    <ul className="navbar-nav ml-auto">
      <li className="nav-item dropdown">
        ...
        <div className="dropdown-menu" id="dropdo" aria-labelledby="navbarDropdown">
                    <label className="text_deco">Mon compte </label><p>Bienvenue : {user.user}</p>
          <a className="dropdown-item a_navbar"  href="/configuration" title="configuration"><i className="fas fa-wrench"></i> Configuration</a>
  
          <div className="dropdown-divider"></div>
         <a className="dropdown-item a_navbar" href="/test" title="test" ><i className="fas fa-sign-out-alt"></i> Deconnexion</a>
        </div>
      </li>
